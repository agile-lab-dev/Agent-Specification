...
#   timestamp: 2025-03-21T11:56:21+00:00
...
class AgentDescriptor(BaseModel):
    ...
    decisionFrequency: Optional[DecisionFrequency] = Field(
        None, description='How often the agent takes decisions', example='Scheduled'
    )
